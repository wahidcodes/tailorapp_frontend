...
//    const templateObj = {customerName:"wahid",description:"no desc",dateReceived:"14/05/2024",amount:"200",paidAmount:"150"}
    const orgObj = {phoneNo, customerName, template, message};
    ...
    const submit = ()=>{
        ...
        if(user){
            ...
            fetch(`${import.meta.env.VITE_API_URL}/sendsms`,{
                method:'POST',
                headers: {'Content-Type':'application/json','Authorization':`Bearer ${user.token}`},
    ...
    return (  
        <>
            ...
            <div className="row">
                ...
                <div className="col-xs-12 col-md-1" >
                    <button type="submit" className="btn btn-primary" style={{width:'9em'}} onClick={()=>submit()}>Send SMS</button>
                </div>
                <div className="col-xs-12 col-md-4" />
            </div>
            <br /><br />
